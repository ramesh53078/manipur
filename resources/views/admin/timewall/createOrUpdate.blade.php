...
@section('title', isset($timeWall) ? 'Edit Time Wall' : 'Add Time Wall')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ isset($timeWall) ? 'Edit Time Wall' : 'Add Time Wall' }}</h3>
                        </div>
                        <form action="{{ isset($timeWall) ? route('admin.timewall.updateTimeWall', $timeWall->id) : route('admin.timewall.storeTimeWall') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if(isset($timeWall))
                                @method('PUT')
                            @endif
